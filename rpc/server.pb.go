...
var file_rpc_server_proto_msgTypes = make([]protoimpl.MessageInfo, 59)
var file_rpc_server_proto_goTypes = []any{
	...
	(*TokenRequest)(nil),                    // 59: rpc.TokenRequest
	(*TokenResponse)(nil),                   // 60: rpc.TokenResponse
	nil,                                     // 61: rpc.Member.GroupAssignmentsEntry
}
var file_rpc_server_proto_depIdxs = []int32{
	...
	61, // 2: rpc.Member.group_assignments:type_name -> rpc.Member.GroupAssignmentsEntry
	...
	59, // 29: rpc.CLI.Token:input_type -> rpc.TokenRequest
	53, // 30: rpc.CLI.GetVotingSessions:input_type -> rpc.GetVotingSessionsRequest
	56, // 31: rpc.CLI.GetVotingSessionDetails:input_type -> rpc.GetVotingSessionDetailsRequest
	12, // 32: rpc.Server.ConfigSync:input_type -> rpc.ConfigSyncRequest
	14, // 33: rpc.Server.MakePassive:input_type -> rpc.MakePassiveRequest
	16, // 34: rpc.Server.BringUpIP:input_type -> rpc.UpIpRequest
	18, // 35: rpc.Server.BringDownIP:input_type -> rpc.DownIpRequest
	20, // 36: rpc.Server.HealthCheck:input_type -> rpc.HealthCheckRequest
	22, // 37: rpc.Server.Logs:input_type -> rpc.LogsRequest
	24, // 38: rpc.Server.Remove:input_type -> rpc.RemoveRequest
	46, // 39: rpc.Server.StartVotingSession:input_type -> rpc.StartVotingSessionRequest
	48, // 40: rpc.Server.CastVote:input_type -> rpc.CastVoteRequest
	50, // 41: rpc.Server.GetVotingResult:input_type -> rpc.GetVotingResultRequest
	4,  // 42: rpc.CLI.Join:output_type -> rpc.JoinResponse
	6,  // 43: rpc.CLI.Leave:output_type -> rpc.LeaveResponse
	8,  // 44: rpc.CLI.Status:output_type -> rpc.StatusResponse
	11, // 45: rpc.CLI.Promote:output_type -> rpc.PromoteResponse
	27, // 46: rpc.CLI.SetMode:output_type -> rpc.SetModeResponse
	29, // 47: rpc.CLI.CreateGroup:output_type -> rpc.CreateGroupResponse
	31, // 48: rpc.CLI.AddIPToGroup:output_type -> rpc.AddIPToGroupResponse
	33, // 49: rpc.CLI.RemoveIPFromGroup:output_type -> rpc.RemoveIPFromGroupResponse
	35, // 50: rpc.CLI.AssignGroupToNode:output_type -> rpc.AssignGroupResponse
	41, // 51: rpc.CLI.UnassignGroupFromNode:output_type -> rpc.UnassignGroupResponse
	43, // 52: rpc.CLI.DeleteGroup:output_type -> rpc.DeleteGroupResponse
	39, // 53: rpc.CLI.ListGroups:output_type -> rpc.ListGroupsResponse
	45, // 54: rpc.CLI.CreateCluster:output_type -> rpc.CreateClusterResponse
	60, // 55: rpc.CLI.Token:output_type -> rpc.TokenResponse
	55, // 56: rpc.CLI.GetVotingSessions:output_type -> rpc.GetVotingSessionsResponse
	58, // 57: rpc.CLI.GetVotingSessionDetails:output_type -> rpc.GetVotingSessionDetailsResponse
	13, // 58: rpc.Server.ConfigSync:output_type -> rpc.ConfigSyncResponse
	15, // 59: rpc.Server.MakePassive:output_type -> rpc.MakePassiveResponse
	17, // 60: rpc.Server.BringUpIP:output_type -> rpc.UpIpResponse
	19, // 61: rpc.Server.BringDownIP:output_type -> rpc.DownIpResponse
	21, // 62: rpc.Server.HealthCheck:output_type -> rpc.HealthCheckResponse
	23, // 63: rpc.Server.Logs:output_type -> rpc.LogsResponse
	25, // 64: rpc.Server.Remove:output_type -> rpc.RemoveResponse
	47, // 65: rpc.Server.StartVotingSession:output_type -> rpc.StartVotingSessionResponse
	49, // 66: rpc.Server.CastVote:output_type -> rpc.CastVoteResponse
	52, // 67: rpc.Server.GetVotingResult:output_type -> rpc.GetVotingResultResponse
